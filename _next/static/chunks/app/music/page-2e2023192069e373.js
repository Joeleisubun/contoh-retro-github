(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[466], {
    2970: (e, s, a) => {
        ...
        function m() {
            ...
            d.useEffect)( () => {
                ...
                if (!e)
                    return;
                let s = () => {
                    e.duration && (m(e.currentTime / e.duration * 100),
                    j(e.currentTime))
                }
                  , a = () => {
                    u(e.duration)
                ...
                ;
                return e.addEventListener("timeupdate", s),
                ...
                t.jsxs)("div", {
                    ...
                    t.jsxs)("div", {
                        ...
                        t.jsxs)("div", {
                            ...
                            t.jsx)("button", {
                                onClick: () => {
                                    a ? v.current.pause() : v.current.play(),
                                    c(!a)
                                }
                                ,
    ...
    var s = s => e(e.s = s);
    e.O(0, [874, 741, 441, 684, 358], () => s(2970)),
    _N_E = e.O()
}
]);
