(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[177], {
    ...
    4869: (e, t, r) => {
        ...
        function o(e) {
            ...
            return (0,
            s.useEffect)( () => {
                r.current || (r.current = new Audio("/music/lagu latar.mp3"),
                r.current.loop = !0);
                let e = () => {
                ...
                "/music" === o ? r.current && r.current.pause() : r.current && r.current.paused && r.current.play().catch(e => {
                    console.log("Playback error during route change:", e)
                }
                ),
                () => {
                    document.removeEventListener("click", t),
                    window.removeEventListener("loadingComplete", e)
                }
            }
            , [o]),
            (0,
    ...
    ,
    9270: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 4178)),
        Promise.resolve().then(r.bind(r, 4869)),
        Promise.resolve().then(r.t.bind(r, 9324, 23)),
        Promise.resolve().then(r.t.bind(r, 3013, 23))
    }
    ,
    9324: () => {}
}, e => {
    var t = t => e(e.s = t);
    e.O(0, [92, 441, 684, 358], () => t(9270)),
    _N_E = e.O()
}
]);
